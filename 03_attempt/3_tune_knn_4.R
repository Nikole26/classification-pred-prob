...
# Define and fit Knn model with Recipe 3----
...
load(here("03_attempt/recipes/recipe_4.rda"))
...
set.seed(5673)
knn_tune_4 <- tune_grid(knn_wflow,
                       air_bnb_folds,
                       grid = knn_grid,
...
save(knn_tune_4, 
     file = here("03_attempt/results/knn_tune_4.rda"))
