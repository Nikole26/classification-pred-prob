...
# saving results-------
save(final_fit_rf, file = here("08_attempt/results/final_fit_rf.rda"))
...
# Best Model --------
select_best(rf_tune_3, metric = "roc_auc")

# finalize workflow for roc-----
final_wflow_roc <- rf_tune_3 |>
  extract_workflow(rf_tune_3) |>
  finalize_workflow(select_best(rf_tune_3, metric = "roc_auc"))
...
# saving results-------
save(final_fit_rf_1, file = here("08_attempt/results/final_fit_rf_1.rda"))
