...
combined_plot <- plot_grid(bt_autoplot_2, bt_autoplot_1, labels = c("Attempt 09 Boosted Tree Hyperparameters", "Attempt 10 Boosted Tree Hyperparameters"))
combined_plot
```
